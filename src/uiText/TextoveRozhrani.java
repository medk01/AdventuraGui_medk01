...
public class TextoveRozhrani {
     ...
     *  Vytváří hru.
     *  
     *  @param hra s ktorou budeme pracovat
     */
    // 
    public TextoveRozhrani(IHra hra) {   
        // inštancia triedy Hra sa može vykonať aj v triede Start, treba preniesť premennú hra
        //IHra hra = new Hra(new TextoveDotazy()); //=inštancia
        this.hra = hra;
    }
